package ru.lingstra.communications.ui.base
...
abstract class MviBaseDialogFragment<V : MvpView, P : MviPresenter<V, *>> : MviDialogFragment<V, P>(), DisposablesProvider by AppDisposables() {
    companion object {
